...
app.put('/mkms/creditors/edit',(req,res)=>{
  ...
  const sql1 = 'UPDATE creditors SET saizo_id = ?, name = ?, name_kana = ?, caption = ?, old_name = ?, branch = ?, area = ?, accept = ?, survey_only = ?, survey_only_memo = ?, self_culculation = ?, caution = ?, phone_survey = ?, fax = ?, post_code = ?, address = ?, survey_memo = ?, disclosure_period = ?, return_contract = ?,number = ?, can_wait = ?, accurued_interest = ?, future_interest = ?, minimum_payment = ?, contract_creator = ?, prescription_contract = ?, policy_memo_debt = ?, negotiation_memo_debt = ?, until_proposal = ?, maximum_proposal = ?, return_date = ?, policy_memo_overpayment = ?, negotiation_memo_overpayment = ?, contract_return = ?, trial_memo = ?, trial_maximum_proposal = ? WHERE id = ?;'
  const values1 = [creditor.saizo_id, creditor.name, creditor.name_kana, creditor.caption, creditor.old_name, creditor.branch, creditor.area, creditor.accept, creditor.survey_only, creditor.survey_only_memo, creditor.self_culculation,creditor.caution, creditor.phone_survey,creditor.fax, creditor.post_code, creditor.address, creditor.survey_memo, creditor.disclosure_period, creditor.return_contract, creditor.number, creditor.can_wait, creditor.accurued_interest, creditor.future_interest, creditor.minimum_payment, creditor.contract_creator, creditor.prescription_contract, creditor.policy_memo_debt, creditor.negotiation_memo_debt, creditor.until_proposal, creditor.maximum_proposal, creditor.return_date, creditor.policy_memo_overpayment, creditor.negotiation_memo_overpayment, creditor.contract_return, creditor.trial_memo, creditor.trial_maximum_proposal, creditor.id]
